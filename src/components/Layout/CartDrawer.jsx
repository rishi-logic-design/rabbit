...
const CartDrawer = ({drawerOpen, toggleCartDrawer}) => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[35rem] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col ease-in-out z-50 ${
    ...
    >
        ...
        <div className="flex-grow p4 overflow-y-auto">
